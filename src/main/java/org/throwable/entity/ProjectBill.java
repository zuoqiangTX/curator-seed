...
public class ProjectBill {
    ...
    public ProjectBill(String userId, String orderNo, int currentPeroid, int totalPeroids, String amount) {
        this.userId = userId;
        this.orderNo = orderNo;
        this.currentPeroid = currentPeroid;
        this.totalPeroids = totalPeroids;
        this.amount = amount;
    }
    ...
    public int getCurrentPeroid() {
        return currentPeroid;
    }

    public void setCurrentPeroid(int currentPeroid) {
        this.currentPeroid = currentPeroid;
    }

    public int getTotalPeroids() {
        return totalPeroids;
    }

    public void setTotalPeroids(int totalPeroids) {
        this.totalPeroids = totalPeroids;
    }
